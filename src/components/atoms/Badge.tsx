...
export default function Badge({ children, variant = 'secondary', className = '' }: BadgeProps) {
  const baseClasses = "px-3.5 py-1 text-xs sm:text-sm font-extrabold inline-block select-none border-2 border-black rounded-[255px_15px_225px_15px/15px_225px_15px_255px]";
  const variants = {
